function krizancAlgorithm() {
    ...
    function buildSlide(titleEn, titleGr, gridState, mode, phaseSteps, totalSteps) {
        ...
        for (let r = 1; r <= n; r++) {
            ...
            for (let c = 1; c <= n; c++) {
                ...
                packets.forEach(p => {
                    ...
                    if (p.moved) span.style.fontWeight = 'bold';
                    ...
                    if (mode === 'analysis1') {
                        ...
                        tag.style.color = isLong ? '#c0392b' : '#27ae60';
                        tag.textContent = isLong ? 'L' : 'S';
    ...
    // ── Build slides ──
    const slides = [
        buildSlide('Initial Grid',  'Αρχικό Πλέγμα',        gridInitial,  'normal',    0,        0),
